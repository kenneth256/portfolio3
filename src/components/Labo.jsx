...
const HackerRoom =(props) => {
  ...
  const monitorText = useTexture('textures/desk/desk.png')
  const screenText = useTexture('textures/desk/monitor.png')
  const tableText = useTexture('textures/desk/chair.png')
  ...
  return (
    <group {...props} dispose={null}>
      <mesh castShadow  receiveShadow geometry={nodes.screen_screens_0.geometry} material={materials.screens}>
        <meshMatcapMaterial map={monitorText} />
      ...
      <meshMatcapMaterial map={screenText} />
      </mesh>
